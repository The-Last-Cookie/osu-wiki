...
*Für [Spielmodi](/wiki/Game_mode)-spezifische Ranking-Kriterien, siehe: [osu!](osu!), [osu!taiko](osu!taiko), [osu!catch](osu!catch) und [osu!mania](osu!mania)*

Die **Ranking-Kriterien** legen die [Regeln und Richtlinien](#gebräuchliche-begriffe) fest, die [Beatmaps](/wiki/Beatmap) befolgen müssen, um das [Beatmap-Ranking-Verfahren](/wiki/Beatmap_ranking_procedure) zu durchlaufen.

Änderungen der Regeln und Richtlinien in diesem Dokument werden im [Forum für Ranking-Kriterien](https://osu.ppy.sh/community/forums/87) vorgeschlagen und diskutiert. Siehe *[How to propose Ranking Criteria changes](https://osu.ppy.sh/community/forums/topics/720532)* als Hilfe beim Mitwirken. Bedenke, dass Änderungen an diesem Dokument, die die Sprache, die Grammatik oder die Gestaltung betreffen, nicht im Forum veröffentlicht werden müssen, solange sie nicht die Bedeutung der Regeln oder Richtlinien ändern.
...
- **Regeln:** All rules are exactly that: **rules**. They are **not** guidelines and may **not** be broken under **any** circumstance.
- **Richtlinien:** Guidelines may be ignored under **exceptional** circumstances. These exceptional circumstances must be justified by an exhaustive explanation as of why the guideline has been ignored and why not ignoring it will interfere with the overall quality of the creation.
