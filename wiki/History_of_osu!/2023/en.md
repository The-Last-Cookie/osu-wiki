...
[EEEEEEEEEEEEEEE](https://osu.ppy.sh/users/2927048) played all ranked beatmaps in the [osu! game mode](/wiki/Game_mode/osu!) as of March 12 and is thus the third to receive the osu!completionist title.[^completionist-tweet]
...
Another tag was added to the BBCode syntax. The `[imagemap]` tag would allow adding several hyperlink areas to a single image.[^imagemap-tag]
