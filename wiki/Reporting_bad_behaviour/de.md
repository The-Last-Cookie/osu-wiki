...
osu! hat ein Team von Moderatoren, das [globale Moderationsteam](/wiki/People/Global_Moderation_Team) (GMT), die sich dem Sauberhalten und dem Schutz der Community verschrieben haben. Wenn dir regelbrechendes Verhalten oder anstößiger Inhalt auffällt, dann melde es über eine der unten beschriebenen Methoden. Alternativ darfst du auch einen der Moderatoren direkt ansprechen, sofern deine Meldung nicht in einem angemessenen Zeitraum bearbeitet wurde — mache dies nur als letzte Möglichkeit.

Versehentliche Meldungen werden ignoriert. Benutzer, die absichtlich falsche Meldungen senden, laufen Gefahr [stumm geschaltet](/wiki/Silence) zu werden.
...
| Unangemessener Inhalt in [gerankten](/wiki/Beatmap/Category#ranked) Beatmaps[^invalid-reports] | [Nomination Assessment Team](/wiki/People/Nomination_Assessment_Team) (NAT) oder [GMT](/wiki/People/Global_Moderation_Team), via der Webseite für [BN-Management](https://bn.mappersguild.com/reports) |
| Unangemessenes Verhalten von einem [Beatmap Nominator](/wiki/People/Beatmap_Nominators) | [NAT](/wiki/People/Nomination_Assessment_Team), via der Webseite für [BN-Management](https://bn.mappersguild.com/reports) |
...
| Beatmap-Plagiate oder andere Urheberrechtsverletzungen | Sende wie in der [osu!-Urheberrechtsrichtlinie](/wiki/Legal/Copyright) beschrieben einen [DMCA-Antrag](https://de.wikipedia.org/wiki/Digital_Millennium_Copyright_Act) an [copyright@ppy.sh](mailto:copyright@ppy.sh). |
...
![](img/report-lazer-1.png "Aktionsmenü mit dem Meldebutton")
...
[^invalid-reports]: Im Gegensatz zu anderen Kategorien können gerankte Beatmaps nicht über die Webseite gemeldet werden.
