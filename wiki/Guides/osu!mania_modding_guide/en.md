...
<!-- TODO:
- see what elements of this guide are common to all game modes, and split accordingly
- make reference article equivalents for the content of this guide (if it doesn't exist already)
- add links to terms
